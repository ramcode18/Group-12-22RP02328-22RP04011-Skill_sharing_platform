        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mb-4">
                        <h3 class="text-lg font-medium text-gray-900">Request a New Skill</h3>
                        <form action="{{ route('skills.store') }}" method="POST" class="mt-4">
                            ...
                            <div class="mt-4">
                                <x-primary-button>{{ __('Request Skill') }}</x-primary-button>
                            </div>
                        </form>
                    </div>

                    <div class="mt-8">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Requested Skills</h3>
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                            @foreach($requestedSkills as $skill)
                                <div class="bg-white p-6 rounded-lg shadow">
                                    ...
                                    <p class="text-sm text-gray-500 mt-2">Requested by: {{ $skill->user->name }}</p>
